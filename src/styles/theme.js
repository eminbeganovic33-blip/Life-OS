...
export const S = {
  ...
  // G5: Move XP popup to upper third so it doesn't cover the quest being checked
  xpPop: { position: "fixed", top: "28%", left: "50%", transform: "translate(-50%,-50%)", fontSize: 28, fontWeight: T.weight.black, color: "#FACC15", textShadow: "0 0 24px rgba(250,204,21,0.5)", pointerEvents: "none", zIndex: 999 },
