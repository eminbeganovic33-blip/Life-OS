export const S = {
  app: { width: "100%", maxWidth: 430, margin: "0 auto", minHeight: "100vh", background: "linear-gradient(180deg,#08080F 0%,#0D0D18 50%,#08080F 100%)", fontFamily: "'SF Pro Display','Segoe UI',system-ui,sans-serif", color: "#E2E2EE", position: "relative", display: "flex", flexDirection: "column" },
  content: { flex: 1, overflowY: "auto", paddingBottom: 76 },
  vc: { paddingTop: 6, paddingBottom: 12 },

  // Loading
  loadScreen: { width: "100%", minHeight: "100vh", background: "#08080F", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", fontFamily: "system-ui" },
  ...
  obCard: { padding: 14, borderRadius: 14, background: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.06)", textAlign: "center", display: "flex", flexDirection: "column", alignItems: "center", gap: 4 },
  obChips: { display: "flex", flexWrap: "wrap", gap: 6, justifyContent: "center", marginBottom: 24 },
  obChip: { padding: "4px 12px", borderRadius: 16, border: "1px solid", fontSize: 12, fontWeight: 600, background: "rgba(255,255,255,0.02)" },
  ...
  pBarOut: { height: 5, borderRadius: 3, background: "rgba(255,255,255,0.05)", overflow: "hidden" },
  ...
  qCard: { display: "flex", justifyContent: "space-between", alignItems: "center", padding: "12px 14px", borderRadius: 12, background: "rgba(255,255,255,0.025)", cursor: "pointer", border: "1px solid rgba(255,255,255,0.03)" },
  ...
  exCard: { padding: 14, borderRadius: 12, background: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.06)", textAlign: "center", cursor: "pointer", display: "flex", flexDirection: "column", alignItems: "center", gap: 3 },
  setInput: { flex: 2, padding: "8px 10px", borderRadius: 8, border: "1px solid rgba(255,255,255,0.08)", background: "rgba(255,255,255,0.03)", color: "#E2E2EE", fontSize: 14, textAlign: "center", outline: "none", fontFamily: "inherit", fontVariantNumeric: "tabular-nums" },
  addSetBtn: { width: "100%", padding: "10px", borderRadius: 8, border: "1px dashed rgba(255,255,255,0.1)", background: "transparent", color: "rgba(255,255,255,0.3)", fontSize: 12, cursor: "pointer", marginTop: 6 },

  // Journal
  journalInput: { width: "calc(100% - 28px)", margin: "0 14px", padding: 14, borderRadius: 12, border: "1px solid rgba(255,255,255,0.06)", background: "rgba(255,255,255,0.025)", color: "#E2E2EE", fontSize: 13, lineHeight: 1.6, resize: "vertical", outline: "none", fontFamily: "inherit", boxSizing: "border-box" },
  ...
  pastEntry: { margin: "0 14px 8px", padding: 12, borderRadius: 10, background: "rgba(255,255,255,0.025)", border: "1px solid rgba(255,255,255,0.03)" },
  ...
  // Academy
  courseCard: { margin: "0 14px 10px", padding: 16, borderRadius: 14, background: "rgba(255,255,255,0.025)", border: "1px solid rgba(255,255,255,0.04)" },
  courseHead: { display: "flex", justifyContent: "space-between", alignItems: "center" },
  courseStep: { display: "flex", gap: 10, alignItems: "flex-start", padding: "8px 0", cursor: "pointer", borderTop: "1px solid rgba(255,255,255,0.03)" },

  // Forge
  forgeCard: { margin: "0 14px 10px", padding: 16, borderRadius: 14, background: "rgba(255,255,255,0.025)", border: "1px solid rgba(255,255,255,0.04)" },
  ...
  forgeMeter: { height: 4, borderRadius: 2, background: "rgba(255,255,255,0.04)", overflow: "hidden", marginTop: 10 },
  ...
  trophyCard: { padding: 14, borderRadius: 12, background: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.04)", display: "flex", flexDirection: "column", alignItems: "center", gap: 2 },
  ...
  // Pomodoro
  pomCard: { margin: "0 14px", padding: 20, borderRadius: 16, background: "rgba(255,255,255,0.025)", border: "1px solid rgba(255,255,255,0.04)", display: "flex", flexDirection: "column", alignItems: "center" },
  ...
  timerBtnSec: { padding: "10px 24px", borderRadius: 10, border: "1px solid rgba(255,255,255,0.08)", background: "transparent", color: "rgba(255,255,255,0.4)", fontSize: 13, fontWeight: 600, cursor: "pointer" },

  // Stats
  statsGrid: { display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 6, padding: "0 14px" },
  statCard: { padding: 12, borderRadius: 12, background: "rgba(255,255,255,0.025)", border: "1px solid rgba(255,255,255,0.04)", textAlign: "center" },
